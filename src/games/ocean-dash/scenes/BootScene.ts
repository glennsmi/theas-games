...
export class BootScene extends Phaser.Scene {
  ...
  createGameAssets() {
    ...
    // Create golden shell sprite
    this.createGoldenShellSprite()
  ...
  createGoldenShellSprite() {
    ...
    graphics.lineTo(2, 8)
    graphics.arc(12, 8, 10, Math.PI, 0, false)
    graphics.lineTo(12, 22)
    graphics.closePath()
    graphics.fillPath()
    
    // Shell ridges
    graphics.lineStyle(1, COLORS.brightCoral)
    graphics.lineBetween(12, 22, 6, 4)
    graphics.lineBetween(12, 22, 12, 2)
    graphics.lineBetween(12, 22, 18, 4)
    
    // Sparkle
    graphics.fillStyle(COLORS.white)
    graphics.fillCircle(8, 6, 2)
    
    graphics.generateTexture('goldenShell', 24, 24)
    graphics.destroy()
  }
